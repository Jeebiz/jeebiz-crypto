...
import net.jeebiz.crypto.keypair.KeyPairCrypto.KeyPairEntry;
import net.jeebiz.crypto.keypair.algorithm.RSACrypto;

public class RSABase64Crypto_Test {
	...
	public void setup() throws Exception {
		...
		KeyPairEntry<RSAPublicKey, RSAPrivateKey> keyEntry = crypto.genKeyEntry(1024);
