 ...
 * @time : 下午7:37:41
 */
public class HmacBase64Codec implements StringEncoder,BinaryEncoder,StringVerifier {
	
	private byte[] base64Key = null;
	private String algorithm = Algorithm.KEY_HMAC_MD5;
	private static HmacBase64Codec instance = null;
	
	private HmacBase64Codec(){};
	
	private HmacBase64Codec(byte[] base64Key){
		this.base64Key = base64Key;
	};
	
	private HmacBase64Codec(byte[] base64Key,String algorithm){
		this.base64Key = base64Key;
		this.algorithm = algorithm;
	};
	
	public static HmacBase64Codec getInstance(byte[] base64Key){
		instance= (instance==null)?instance=new HmacBase64Codec(base64Key):instance;
		instance.base64Key = base64Key;
		return  instance;
	}
	
	public static HmacBase64Codec getInstance(byte[] base64Key,String algorithm){
		instance= (instance==null)?instance=new HmacBase64Codec(base64Key):instance;
		instance.base64Key = base64Key;
	...
	public byte[] encodeHmacMD2(byte[] plainBytes) throws EncoderException {
		//获取HmacMD2消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_MD2).encode(plainBytes);
	}
	
	public String encodeHmacMD2(String plainText) throws EncoderException {
		//获取HmacMD2消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_MD2).encode(plainText);
	}
	
	public byte[] encodeHmacMD4(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_MD4).encode(plainBytes);
	}
	
	public String encodeHmacMD4(String plainText) throws EncoderException {
		//获取HmacMD4消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_MD4).encode(plainText);
	}
	
	public byte[] encodeHmacSHA1(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA1).encode(plainBytes);
	}
	
	public String encodeHmacSHA1(String plainText) throws EncoderException {
		//获取HmacSHA1消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA1).encode(plainText);
	}
	
	public byte[] encodeHmacSHA224(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA224).encode(plainBytes);
	}
	
	public String encodeHmacSHA224(String plainText) throws EncoderException {
		//获取HmacSHA224消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA224).encode(plainText);
	}
	
	public byte[] encodeHmacSHA256(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA256).encode(plainBytes);
	}
	
	public String encodeHmacSHA256(String plainText) throws EncoderException {
		//获取HmacSHA256消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA256).encode(plainText);
	}
	
	public byte[] encodeHmacSHA384(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA384).encode(plainBytes);
	}
	
	public String encodeHmacSHA384(String plainText) throws EncoderException {
		//获取HmacSHA384消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA384).encode(plainText);
	}
	
	public byte[] encodeHmacSHA512(byte[] plainBytes) throws EncoderException {
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA512).encode(plainBytes);
	}
	
	public String encodeHmacSHA512(String plainText) throws EncoderException {
		//获取HmacSHA512消息摘要信息
		return HmacBase64Codec.getInstance(base64Key, Algorithm.KEY_HMAC_SHA512).encode(plainText);
	}
	...
	public static void main(String[] args) throws Exception {
		...
		HmacBase64Codec codec1 = HmacBase64Codec.getInstance(Base64.encodeBase64(keyText.getBytes()));
		...
		HmacBase64Codec codec = HmacBase64Codec.getInstance(base64Key);
		//获取HmacMD5消息摘要信息
		System.out.println("HmacMD5算法摘要："+ codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_SHA256);
		//获取摘要信息
		System.out.println("HmacSHA256算法摘要："+ codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_SHA1);
		//获取摘要信息
		System.out.println("HmacSHA1算法摘要："+ codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_SHA384);
		//获取摘要信息
		System.out.println("HmacSHA384算法摘要："+codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_SHA512);
		//获取摘要信息
		...
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_MD2);
		//获取摘要信息
		System.out.println("Bouncycastle HmacMD2算法摘要："+ codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_MD4);
		//获取摘要信息
		System.out.println("Bouncycastle HmacMD4算法摘要："+ codec.encode(plainText));
		
		//初始化密钥
		codec = HmacBase64Codec.getInstance(base64Key,Algorithm.KEY_HMAC_SHA224);
		//获取摘要信息
