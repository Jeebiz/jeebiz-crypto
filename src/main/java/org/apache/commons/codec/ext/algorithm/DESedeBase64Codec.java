 ...
 * @description: DESede+ Base64 加密算法
 * @author : wandalong
 * @date : 2014-9-28
 * @time : 下午7:38:13
 */
public class DESedeBase64Codec implements Codec,SecretKeyEncoder,SecretKeyDecoder,FileEncoder,FileDecoder{
	
	private static DESedeBase64Codec instance = null;
	
	private DESedeBase64Codec(){};
	
	public static DESedeBase64Codec getInstance(){
		instance= (instance==null)?instance = new DESedeBase64Codec() :instance;
		return  instance;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		//加密数据
		String encryptedText = DESedeBase64Codec.getInstance().encode(str, encryptKey);
		System.out.println("加密后：/t"+encryptedText);
		//解密数据
		System.out.println("解密后：/t"+DESedeBase64Codec.getInstance().decode(encryptedText, encryptKey));
