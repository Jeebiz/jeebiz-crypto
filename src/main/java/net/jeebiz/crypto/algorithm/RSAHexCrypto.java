...
import net.jeebiz.crypto.utils.StringUtils;
  ...
  *  RSA安全编码组件
  */
 public class RSAHexCrypto implements KeyPairCodec,KeyPairEncoder,KeyPairDecoder,KeyPairVerifier {
   ...
   /**
	...
	public final static  String private_key = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAL/ZvywITcDB1QyBJlYMfiekDIFf"
 	...
 	private static RSAHexCrypto instance = null;
	private RSAHexCrypto(){};
	public static RSAHexCrypto getInstance(){
		instance= (instance==null)?instance=new RSAHexCrypto():instance;
		return  instance;
	}
