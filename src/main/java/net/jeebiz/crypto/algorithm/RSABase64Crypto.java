...
import net.jeebiz.crypto.KeyPairCodec;
import net.jeebiz.crypto.KeyPairDecoder;
import net.jeebiz.crypto.KeyPairEncoder;
import net.jeebiz.crypto.KeyPairVerifier;
...
import net.jeebiz.crypto.utils.StringUtils;
  ...
  *  RSA安全编码组件
  */
 public class RSABase64Crypto implements KeyPairCodec,KeyPairEncoder,KeyPairDecoder,KeyPairVerifier {
	...
	public final static  String private_key = "MIICdgIBADANBgkqhkiG9w0BAQEFAASCAmAwggJcAgEAAoGBAL/ZvywITcDB1QyBJlYMfiekDIFf"
 	...
 	private static RSABase64Crypto instance = null;
	private RSABase64Crypto(){};
	public static RSABase64Crypto getInstance(){
		instance= (instance==null)?instance=new RSABase64Crypto():instance;
		return  instance;
	}
	...
	public PrivateKey toPrivateKey(byte[] base64PrivateKeyBytes) throws GeneralSecurityException {
 	...
 	public String sign(byte[] encryptedBytes, String base64PrivateKeyText) throws GeneralSecurityException {
 		...
 		//用私钥对信息生成数字签名
 		return Base64.encodeBase64String(SignatureUtils.sign(Base64.decodeBase64(encryptedBytes), signature, privateKey));
 	}
 	...
 	public boolean verify(byte[] encryptedBytes, byte[] base64PublicKeyText, String sign) throws GeneralSecurityException {
 		...
 		Signature signature = SignatureUtils.getSignature(Algorithm.KEY_SIGNATURE_RSA);
 		// 验证签名是否正常
 		return SignatureUtils.verify(Base64.decodeBase64(encryptedBytes), Base64.decodeBase64(sign), signature, publicKey);
 	}
